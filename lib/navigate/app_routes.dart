...
import 'package:gestao_producao_chopp/features/producoes/presentation/screens/editar_grade/editar_grade_screen.dart';
...
class AppRoutes {
  static final routes = [
    ...
    GoRoute(
        ...
        builder: (context, state) => AlterarSenhaScreen()
    ),

    GoRoute(
        path: AppRoutesNames.deletarConta,
        builder: (context, state) => DeletarContaScreen()
    ),

    GoRoute(
        path: AppRoutesNames.listaGrades,
        builder: (context, state) => ListaGradesScreen()
    ),
