...
part of 'buscar_anotacoes_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BuscarAnotacoesState);
}
...
/// @nodoc
class $BuscarAnotacoesStateCopyWith<$Res>  {
$BuscarAnotacoesStateCopyWith(BuscarAnotacoesState _, $Res Function(BuscarAnotacoesState) __);
}


/// Adds pattern-matching-related methods to [BuscarAnotacoesState].
extension BuscarAnotacoesStatePatterns on BuscarAnotacoesState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  inicial,TResult Function()?  carregando,TResult Function( List<AnotacaoEntity> producao)?  sucessoComDados,TResult Function()?  sucesso,TResult Function( Failure failure)?  erro,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Inicial() when inicial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  inicial,required TResult Function()  carregando,required TResult Function( List<AnotacaoEntity> producao)  sucessoComDados,required TResult Function()  sucesso,required TResult Function( Failure failure)  erro,}) {final _that = this;
switch (_that) {
case _Inicial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  inicial,TResult? Function()?  carregando,TResult? Function( List<AnotacaoEntity> producao)?  sucessoComDados,TResult? Function()?  sucesso,TResult? Function( Failure failure)?  erro,}) {final _that = this;
switch (_that) {
case _Inicial() when inicial != null:
return inicial();case _Carregando() when carregando != null:
return carregando();case _SucessoComDados() when sucessoComDados != null:
...
class _Inicial implements BuscarAnotacoesState {
  const _Inicial();
...
@override
String toString() {
  return 'BuscarAnotacoesState.inicial()';
}
...
class _Carregando implements BuscarAnotacoesState {
  const _Carregando();
...
@override
String toString() {
  return 'BuscarAnotacoesState.carregando()';
}
...
class _SucessoComDados implements BuscarAnotacoesState {
  const _SucessoComDados(final  List<AnotacaoEntity> producao): _producao = producao;
  

 final  List<AnotacaoEntity> _producao;
 List<AnotacaoEntity> get producao {
  if (_producao is EqualUnmodifiableListView) return _producao;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_producao);
}


/// Create a copy of BuscarAnotacoesState
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SucessoComDados&&const DeepCollectionEquality().equals(other._producao, _producao));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_producao));

@override
String toString() {
  return 'BuscarAnotacoesState.sucessoComDados(producao: $producao)';
}
...
/// @nodoc
abstract mixin class _$SucessoComDadosCopyWith<$Res> implements $BuscarAnotacoesStateCopyWith<$Res> {
...
null == producao ? _self._producao : producao // ignore: cast_nullable_to_non_nullable
as List<AnotacaoEntity>,
  ));
}
...
class _Sucesso implements BuscarAnotacoesState {
  const _Sucesso();
...
@override
String toString() {
  return 'BuscarAnotacoesState.sucesso()';
}
...
class _Erro implements BuscarAnotacoesState {
...
@override
String toString() {
  return 'BuscarAnotacoesState.erro(failure: $failure)';
}
...
/// @nodoc
abstract mixin class _$ErroCopyWith<$Res> implements $BuscarAnotacoesStateCopyWith<$Res> {
