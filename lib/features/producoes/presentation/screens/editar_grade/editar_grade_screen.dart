...
import 'package:gestao_producao_chopp/features/producoes/presentation/screens/editar_grade/editar_grade_notifier.dart';
              ...
              children: [
                ...
                ElevatedButtonCentralizado(
                  ...
                  clique: () {
                    ...
                    ref.read(editarGradeNotifierProvider.notifier).editarGrade(grade: grade, gradeId: grade.id!);
                  },
                )
              ],
            )
