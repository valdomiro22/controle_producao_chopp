...
/// @nodoc
mixin _$BuscarConfiguracaoState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BuscarConfiguracaoState);
}
...
@override
String toString() {
  return 'BuscarConfiguracaoState()';
}
...
/// @nodoc
class $BuscarConfiguracaoStateCopyWith<$Res>  {
$BuscarConfiguracaoStateCopyWith(BuscarConfiguracaoState _, $Res Function(BuscarConfiguracaoState) __);
}


/// Adds pattern-matching-related methods to [BuscarConfiguracaoState].
extension BuscarConfiguracaoStatePatterns on BuscarConfiguracaoState {
...
class _Inicial implements BuscarConfiguracaoState {
  const _Inicial();
...
@override
String toString() {
  return 'BuscarConfiguracaoState.inicial()';
}
...
class _SucessoComDados implements BuscarConfiguracaoState {
  const _SucessoComDados(this.config);
  

 final  ConfiguracoesEntity? config;

/// Create a copy of BuscarConfiguracaoState
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SucessoComDados&&(identical(other.config, config) || other.config == config));
}
...
@override
String toString() {
  return 'BuscarConfiguracaoState.sucessoComDados(config: $config)';
}
...
/// @nodoc
abstract mixin class _$SucessoComDadosCopyWith<$Res> implements $BuscarConfiguracaoStateCopyWith<$Res> {
...
freezed == config ? _self.config : config // ignore: cast_nullable_to_non_nullable
as ConfiguracoesEntity?,
  ));
}
...
class _Sucesso implements BuscarConfiguracaoState {
  const _Sucesso();
...
@override
String toString() {
  return 'BuscarConfiguracaoState.sucesso()';
}
...
class _Erro implements BuscarConfiguracaoState {
...
@override
String toString() {
  return 'BuscarConfiguracaoState.erro(failure: $failure)';
}
...
/// @nodoc
abstract mixin class _$ErroCopyWith<$Res> implements $BuscarConfiguracaoStateCopyWith<$Res> {
