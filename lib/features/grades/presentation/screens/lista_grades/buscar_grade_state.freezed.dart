...
part of 'buscar_grade_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BuscarGradeState);
}
...
/// @nodoc
class $BuscarGradeStateCopyWith<$Res>  {
$BuscarGradeStateCopyWith(BuscarGradeState _, $Res Function(BuscarGradeState) __);
}


/// Adds pattern-matching-related methods to [BuscarGradeState].
extension BuscarGradeStatePatterns on BuscarGradeState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  inicial,TResult Function()?  carregando,TResult Function( GradeEntity lista)?  sucessoComDados,TResult Function()?  sucesso,TResult Function( Failure failure)?  erro,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Inicial() when inicial != null:
return inicial();case _Carregando() when carregando != null:
return carregando();case _SucessoComDados() when sucessoComDados != null:
return sucessoComDados(_that.lista);case _Sucesso() when sucesso != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  inicial,required TResult Function()  carregando,required TResult Function( GradeEntity lista)  sucessoComDados,required TResult Function()  sucesso,required TResult Function( Failure failure)  erro,}) {final _that = this;
switch (_that) {
case _Inicial():
return inicial();case _Carregando():
return carregando();case _SucessoComDados():
return sucessoComDados(_that.lista);case _Sucesso():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  inicial,TResult? Function()?  carregando,TResult? Function( GradeEntity lista)?  sucessoComDados,TResult? Function()?  sucesso,TResult? Function( Failure failure)?  erro,}) {final _that = this;
switch (_that) {
case _Inicial() when inicial != null:
return inicial();case _Carregando() when carregando != null:
return carregando();case _SucessoComDados() when sucessoComDados != null:
...
class _Inicial implements BuscarGradeState {
  const _Inicial();
...
@override
String toString() {
  return 'BuscarGradeState.inicial()';
}
...
class _Carregando implements BuscarGradeState {
  const _Carregando();
...
@override
String toString() {
  return 'BuscarGradeState.carregando()';
}
...
class _SucessoComDados implements BuscarGradeState {
  const _SucessoComDados(this.lista);
  

 final  GradeEntity lista;

/// Create a copy of BuscarGradeState
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SucessoComDados&&(identical(other.lista, lista) || other.lista == lista));
}


@override
int get hashCode => Object.hash(runtimeType,lista);

@override
String toString() {
  return 'BuscarGradeState.sucessoComDados(lista: $lista)';
}
...
/// @nodoc
abstract mixin class _$SucessoComDadosCopyWith<$Res> implements $BuscarGradeStateCopyWith<$Res> {
...
null == lista ? _self.lista : lista // ignore: cast_nullable_to_non_nullable
as GradeEntity,
  ));
}
...
class _Sucesso implements BuscarGradeState {
  const _Sucesso();
...
@override
String toString() {
  return 'BuscarGradeState.sucesso()';
}
...
class _Erro implements BuscarGradeState {
...
@override
String toString() {
  return 'BuscarGradeState.erro(failure: $failure)';
}
...
/// @nodoc
abstract mixin class _$ErroCopyWith<$Res> implements $BuscarGradeStateCopyWith<$Res> {
