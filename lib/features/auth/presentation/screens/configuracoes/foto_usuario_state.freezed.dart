...
part of 'foto_usuario_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FotoUsuarioState);
}
...
/// @nodoc
class $FotoUsuarioStateCopyWith<$Res>  {
$FotoUsuarioStateCopyWith(FotoUsuarioState _, $Res Function(FotoUsuarioState) __);
}


/// Adds pattern-matching-related methods to [FotoUsuarioState].
extension FotoUsuarioStatePatterns on FotoUsuarioState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  inicial,TResult Function()?  carregando,TResult Function( String fotoUrl)?  sucessoComDados,TResult Function()?  sucesso,TResult Function( Failure failure)?  erro,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Inicial() when inicial != null:
return inicial();case _Carregando() when carregando != null:
return carregando();case _SucessoComDados() when sucessoComDados != null:
return sucessoComDados(_that.fotoUrl);case _Sucesso() when sucesso != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  inicial,required TResult Function()  carregando,required TResult Function( String fotoUrl)  sucessoComDados,required TResult Function()  sucesso,required TResult Function( Failure failure)  erro,}) {final _that = this;
switch (_that) {
case _Inicial():
return inicial();case _Carregando():
return carregando();case _SucessoComDados():
return sucessoComDados(_that.fotoUrl);case _Sucesso():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  inicial,TResult? Function()?  carregando,TResult? Function( String fotoUrl)?  sucessoComDados,TResult? Function()?  sucesso,TResult? Function( Failure failure)?  erro,}) {final _that = this;
switch (_that) {
case _Inicial() when inicial != null:
return inicial();case _Carregando() when carregando != null:
return carregando();case _SucessoComDados() when sucessoComDados != null:
...
class _Inicial implements FotoUsuarioState {
  const _Inicial();
...
@override
String toString() {
  return 'FotoUsuarioState.inicial()';
}
...
class _Carregando implements FotoUsuarioState {
  const _Carregando();
...
@override
String toString() {
  return 'FotoUsuarioState.carregando()';
}
...
class _SucessoComDados implements FotoUsuarioState {
  const _SucessoComDados(this.fotoUrl);
  

 final  String fotoUrl;

/// Create a copy of FotoUsuarioState
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SucessoComDados&&(identical(other.fotoUrl, fotoUrl) || other.fotoUrl == fotoUrl));
}


@override
int get hashCode => Object.hash(runtimeType,fotoUrl);

@override
String toString() {
  return 'FotoUsuarioState.sucessoComDados(fotoUrl: $fotoUrl)';
}
...
/// @nodoc
abstract mixin class _$SucessoComDadosCopyWith<$Res> implements $FotoUsuarioStateCopyWith<$Res> {
...
/// Create a copy of FotoUsuarioState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? fotoUrl = null,}) {
  return _then(_SucessoComDados(
null == fotoUrl ? _self.fotoUrl : fotoUrl // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class _Sucesso implements FotoUsuarioState {
  const _Sucesso();
...
@override
String toString() {
  return 'FotoUsuarioState.sucesso()';
}
...
class _Erro implements FotoUsuarioState {
...
@override
String toString() {
  return 'FotoUsuarioState.erro(failure: $failure)';
}
...
/// @nodoc
abstract mixin class _$ErroCopyWith<$Res> implements $FotoUsuarioStateCopyWith<$Res> {
