...
part of 'buscar_usuario_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BuscarUsuarioState);
}
...
/// @nodoc
class $BuscarUsuarioStateCopyWith<$Res>  {
$BuscarUsuarioStateCopyWith(BuscarUsuarioState _, $Res Function(BuscarUsuarioState) __);
}


/// Adds pattern-matching-related methods to [BuscarUsuarioState].
extension BuscarUsuarioStatePatterns on BuscarUsuarioState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  inicial,TResult Function()?  carregando,TResult Function( UsuarioEntity usuario)?  sucessoComDados,TResult Function()?  sucesso,TResult Function( Failure failure)?  erro,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Inicial() when inicial != null:
return inicial();case _Carregando() when carregando != null:
return carregando();case _SucessoComDados() when sucessoComDados != null:
return sucessoComDados(_that.usuario);case _Sucesso() when sucesso != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  inicial,required TResult Function()  carregando,required TResult Function( UsuarioEntity usuario)  sucessoComDados,required TResult Function()  sucesso,required TResult Function( Failure failure)  erro,}) {final _that = this;
switch (_that) {
case _Inicial():
return inicial();case _Carregando():
return carregando();case _SucessoComDados():
return sucessoComDados(_that.usuario);case _Sucesso():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  inicial,TResult? Function()?  carregando,TResult? Function( UsuarioEntity usuario)?  sucessoComDados,TResult? Function()?  sucesso,TResult? Function( Failure failure)?  erro,}) {final _that = this;
switch (_that) {
case _Inicial() when inicial != null:
return inicial();case _Carregando() when carregando != null:
return carregando();case _SucessoComDados() when sucessoComDados != null:
...
class _Inicial implements BuscarUsuarioState {
  const _Inicial();
...
@override
String toString() {
  return 'BuscarUsuarioState.inicial()';
}
...
class _Carregando implements BuscarUsuarioState {
  const _Carregando();
...
@override
String toString() {
  return 'BuscarUsuarioState.carregando()';
}
...
class _SucessoComDados implements BuscarUsuarioState {
  const _SucessoComDados(this.usuario);
  

 final  UsuarioEntity usuario;

/// Create a copy of BuscarUsuarioState
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SucessoComDados&&(identical(other.usuario, usuario) || other.usuario == usuario));
}
...
@override
String toString() {
  return 'BuscarUsuarioState.sucessoComDados(usuario: $usuario)';
}
...
/// @nodoc
abstract mixin class _$SucessoComDadosCopyWith<$Res> implements $BuscarUsuarioStateCopyWith<$Res> {
...
$UsuarioEntityCopyWith<$Res> get usuario;
...
$UsuarioEntityCopyWith<$Res> get usuario {
  ...
  return $UsuarioEntityCopyWith<$Res>(_self.usuario, (value) {
...
class _Sucesso implements BuscarUsuarioState {
  const _Sucesso();
...
@override
String toString() {
  return 'BuscarUsuarioState.sucesso()';
}
...
class _Erro implements BuscarUsuarioState {
...
@override
String toString() {
  return 'BuscarUsuarioState.erro(failure: $failure)';
}
...
/// @nodoc
abstract mixin class _$ErroCopyWith<$Res> implements $BuscarUsuarioStateCopyWith<$Res> {
