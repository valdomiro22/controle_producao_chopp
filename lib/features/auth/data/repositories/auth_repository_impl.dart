...
class AuthRepositoryImpl implements AuthRepository {
  ...
  @override
  Future<Either<Failure, Unit>> updateEmailAddress({required String newEmail, required String password}) async {
    try {
  ...
  @override
  Future<Either<Failure, Unit>> updatePassword({required String newPassword, required String currentPassword}) async {
    try {
      await _authDataSource.updatePassword(newPassword: newPassword, currentPassword: currentPassword);
      return Right(unit);
    } on AuthException catch (e) {
      return Left(AuthFailure(e.message));
    } on NetworkException catch (e) {
