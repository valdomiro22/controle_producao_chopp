...
part of 'tipo_barril_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TipoBarrilState);
}
...
/// @nodoc
class $TipoBarrilStateCopyWith<$Res>  {
$TipoBarrilStateCopyWith(TipoBarrilState _, $Res Function(TipoBarrilState) __);
}


/// Adds pattern-matching-related methods to [TipoBarrilState].
extension TipoBarrilStatePatterns on TipoBarrilState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  inicial,TResult Function()?  carregando,TResult Function( List<TipoBarrilEntity> lista)?  sucessoComLista,TResult Function()?  sucesso,TResult Function( Failure failure)?  erro,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Inicial() when inicial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  inicial,required TResult Function()  carregando,required TResult Function( List<TipoBarrilEntity> lista)  sucessoComLista,required TResult Function()  sucesso,required TResult Function( Failure failure)  erro,}) {final _that = this;
switch (_that) {
case _Inicial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  inicial,TResult? Function()?  carregando,TResult? Function( List<TipoBarrilEntity> lista)?  sucessoComLista,TResult? Function()?  sucesso,TResult? Function( Failure failure)?  erro,}) {final _that = this;
switch (_that) {
case _Inicial() when inicial != null:
return inicial();case _Carregando() when carregando != null:
return carregando();case _SucessoComLista() when sucessoComLista != null:
...
class _Inicial implements TipoBarrilState {
  const _Inicial();
...
@override
String toString() {
  return 'TipoBarrilState.inicial()';
}
...
class _Carregando implements TipoBarrilState {
  const _Carregando();
...
@override
String toString() {
  return 'TipoBarrilState.carregando()';
}
...
class _SucessoComLista implements TipoBarrilState {
  const _SucessoComLista(final  List<TipoBarrilEntity> lista): _lista = lista;
  

 final  List<TipoBarrilEntity> _lista;
 List<TipoBarrilEntity> get lista {
...
/// Create a copy of TipoBarrilState
...
@override
String toString() {
  return 'TipoBarrilState.sucessoComLista(lista: $lista)';
}
...
/// @nodoc
abstract mixin class _$SucessoComListaCopyWith<$Res> implements $TipoBarrilStateCopyWith<$Res> {
...
class _Sucesso implements TipoBarrilState {
  const _Sucesso();
...
@override
String toString() {
  return 'TipoBarrilState.sucesso()';
}
...
class _Erro implements TipoBarrilState {
...
@override
String toString() {
  return 'TipoBarrilState.erro(failure: $failure)';
}
...
/// @nodoc
abstract mixin class _$ErroCopyWith<$Res> implements $TipoBarrilStateCopyWith<$Res> {
